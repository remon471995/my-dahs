...
const Dashboard = () => {
  // Redirect supervisors to the supervisor dashboard
  useEffect(() => {
    // This is just for informational purposes - the actual redirection is handled in MainContent.jsx
    // since we're using tab-based navigation rather than real routes
  }, []);
